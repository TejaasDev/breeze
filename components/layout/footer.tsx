...
export function Footer() {
    return (
        <footer className="bg-lofi-text text-lofi-bg pt-24 pb-12 font-space-grotesk transition-colors duration-300">
            <div className="container mx-auto px-6 md:px-12">
                ...
                <div className="border-t border-lofi-bg/10 pt-12 flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-[10px] font-black uppercase tracking-widest opacity-40">
                        © {new Date().getFullYear()} BREEZE INC. BUILT FOR GROWTH.
                    </p>
                    <div className="flex gap-4">
                        <div className="w-10 h-10 rounded-full border border-lofi-bg/20 flex items-center justify-center hover:border-lofi-bg transition-colors cursor-pointer">
                            <span className="text-[10px] font-black italic">X</span>
                        </div>
                        <Link
                            href="https://www.instagram.com/breezeapp.ai/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-10 h-10 rounded-full border border-lofi-bg/20 flex items-center justify-center hover:border-lofi-bg transition-colors cursor-pointer"
                        >
