...
export function Hero() {
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20 bg-lofi-bg grid-background font-space-grotesk">
            <div className="container px-6 md:px-12 text-center relative z-10">
                ...
                >
                    <div className="inline-flex items-center rounded-full lofi-border px-6 py-2 text-xs font-black uppercase tracking-widest text-lofi-text bg-lofi-card lofi-shadow">
                    ...
                    <p className="text-base sm:text-lg md:text-2xl text-lofi-text max-w-2xl mx-auto font-medium leading-tight opacity-80">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-10">
                        ...
                        <Link href="#features">
                            <motion.button
                                whileHover={{ scale: 1.05, y: -2 }}
                                whileTap={{ scale: 0.95 }}
                                className="bg-lofi-card text-lofi-text lofi-border px-10 py-5 rounded-[2rem] text-lg font-black uppercase lofi-shadow"
                            >
                                How it Works
                            </motion.button>
                        </Link>
            ...
            <div className="absolute top-10 right-[15%] opacity-20 transform rotate-12 pointer-events-none text-lofi-text">
